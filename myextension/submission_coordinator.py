...
class SubmissionCoordinator:
    ...
    def submit(
        ...
        *,
        ...
        with self._lock_for(canonical_session_id):
            ...
            if existing is None:
                payload = self._prepare_payload(canonical_session_id)
                state = {
    ...
    def _prepare_payload(self, session_id: str) -> dict[str, object]:
        ...
        return self._remote_payload(session_id, profile, brief)
    ...
    def _remote_payload(
        ...
        evidence_refs = self._delivered_evidence_refs(session_id)
    ...
    def _delivered_evidence_refs(self, session_id: str) -> list[str]:
        entries = self._outbox.list_entries(session_id)
        references = [
